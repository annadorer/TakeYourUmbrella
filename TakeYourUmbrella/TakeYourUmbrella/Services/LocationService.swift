...
struct LocationService {
    ...
    func searchLocation(for parameter: String) async throws -> [LocationData] {
        guard let url = URL(string: "https://api.weatherapi.com/v1/search.json?key=\(apiKey)&q=\(parameter)") else { throw NSError() }
